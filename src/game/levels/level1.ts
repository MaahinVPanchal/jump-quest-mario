...
const enemies: EnemySpawn[] = [
  ...
  { type: "ogre", x: 58, y: 11, patrol: 160 },
  { type: "shell", x: 44, y: 15, direction: -1, patrol: 64 },
  { type: "ogre", x: 46, y: 9, patrol: 120 },
  ...
  { type: "ogre", x: 86, y: 10, patrol: 140 },
  { type: "shell", x: 108, y: 18, direction: -1, patrol: 192 },
  { type: "ogre", x: 121, y: 12, patrol: 200 },
  ...
  { type: "ogre", x: 187, y: 12, patrol: 140 },
